...
class Settings:
    ...
    UNSUB_BASE_URL: str = os.getenv("UNSUB_BASE_URL", "https://ecodia.au/eco-local/business/unsubscribe")
    ...
    # Embeddings (Gemini / Google AI)
    GOOGLE_API_KEY: str = os.getenv("GOOGLE_API_KEY", "")
    GEMINI_API_KEY: str = os.getenv("GEMINI_API_KEY", "")  # optional alias

    # Optional: external HTTP base for your site/debug endpoints
    ECO_LOCAL_API_BASE: str = os.getenv("ECO_LOCAL_API_BASE", "")


settings = Settings()

# ---- Backward-compat module-level exports (so `from .config import GOOGLE_API_KEY` keeps working) ----
GOOGLE_API_KEY = settings.GOOGLE_API_KEY or settings.GEMINI_API_KEY  # prefer GOOGLE_API_KEY, fallback GEMINI_API_KEY
GEMINI_API_KEY = settings.GEMINI_API_KEY
ECO_LOCAL_API_BASE = settings.ECO_LOCAL_API_BASE
